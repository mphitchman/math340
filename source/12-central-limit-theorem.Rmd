...
This normal estimate is a little low, and we can improve the estimate by making what is called a *continuity correction*\index{continuity correction}:
...
Actual probability: `pbinom(53,100,.5)-pbinom(50,100,.5)` = `r round(pbinom(53,100,.5)-pbinom(50,100,.5),4)`.

Estimated probability: `pnorm(53.5,50,5)-pnorm(50.5,50,5)` = `r round(pnorm(53.5,50,5)-pnorm(50.5,50,5),4)`.
:::
