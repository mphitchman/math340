...
Given a chance experiment with sample space $S$ that is finite or countably infinite, a **probability distribution function** on the elements of $S$ is a real-valued function $m$ which satisfies these two conditions:
